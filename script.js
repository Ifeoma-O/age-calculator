...
function CheckDayInput()
{
    ...
    if(value == '')
    {
        ...
        document.getElementById("day").style.borderColor = "rgb(255, 87, 87)";
        for (let i = 0; i < label.length; i++) {
            label[i].style.color = "rgb(255, 87, 87)";
        }          
         return false;
    }
...
function CheckMonthInput()
{
    ...
    if(value == '')
    {
       ...
       document.getElementById("month").style.borderColor = "rgb(255, 87, 87)";
       for (let i = 0; i < label.length; i++) {
        label[i].style.color = "rgb(255, 87, 87)";
        }     
        return false;
...
function CheckYearInput() {
    ...
    if (value == '') {
        ...
        document.getElementById("year").style.borderColor = "rgb(255, 87, 87)";
        for (let i = 0; i < label.length; i++) {
            label[i].style.color = "rgb(255, 87, 87)";
        }     
        return false;
